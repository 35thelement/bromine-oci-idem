...
async def test_list_allowed_peer_regions_for_remote_peering(hub, ctx):
    ...
    **Test function**
    ...
    ret = (
        await hub.tool.oci.virtual_network.list_allowed_peer_regions_for_remote_peering(
            ctx,
        )
    )
    assert ret
...
async def test_get_byoip_range(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_byoip_range(
        ctx, opc_request_id=value, byoip_range_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_byoip_range(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_byoip_range(
        ctx, opc_request_id=value, byoip_range_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_byoip_allocated_ranges(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_byoip_allocated_ranges(
        ctx, opc_request_id=value, byoip_range_id=value, limit=value, page=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_create_capture_filter(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.create_capture_filter(
        ...
        filter_type=value,
        freeform_tags=value,
        vtap_capture_filter_rules=value,
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_capture_filter(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_capture_filter(
        ctx, capture_filter_id=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_capture_filter(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_capture_filter(
        ctx, capture_filter_id=value, if_match=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_cpe_device_shapes(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_cpe_device_shapes(
        ctx, limit=value, page=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_cpe_device_shape(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_cpe_device_shape(
        ctx, cpe_device_shape_id=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_cpes(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_cpes(
        ctx, compartment_id=value, limit=value, page=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_cpe(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.get_cpe(ctx, cpe_id=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_delete_cpe(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_cpe(
        ctx, cpe_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_cpe_device_config_content(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_cpe_device_config_content(
        ctx, cpe_id=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_create_cross_connect_group(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.create_cross_connect_group(
        ...
        opc_retry_token=value,
        compartment_id=value,
        customer_reference_name=value,
        defined_tags=value,
        display_name=value,
        freeform_tags=value,
        macsec_properties=value,
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_cross_connect_group(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_cross_connect_group(
        ctx, cross_connect_group_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_cross_connect_group(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_cross_connect_group(
        ctx, cross_connect_group_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_create_cross_connect(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.create_cross_connect(
        ...
        defined_tags=value,
        display_name=value,
        far_cross_connect_or_cross_connect_group_id=value,
        freeform_tags=value,
        location_name=value,
        macsec_properties=value,
        near_cross_connect_or_cross_connect_group_id=value,
        port_speed_shape_name=value,
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_cross_connect(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_cross_connect(
        ctx, cross_connect_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_dhcp_options(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.get_dhcp_options(ctx, dhcp_id=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_delete_dhcp_options(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_dhcp_options(
        ctx, dhcp_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_update_drg_attachment(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.update_drg_attachment(
        ...
        display_name=value,
        drg_route_table_id=value,
        export_drg_route_distribution_id=value,
        freeform_tags=value,
        network_details=value,
        route_table_id=value,
    )
...
async def test_delete_drg_attachment(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_drg_attachment(
        ctx, drg_attachment_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_remove_export_drg_route_distribution(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.remove_export_drg_route_distribution(
        ctx, drg_attachment_id=value, opc_request_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_drg_route_distribution(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_drg_route_distribution(
        ctx, drg_route_distribution_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_drg_route_distribution(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_drg_route_distribution(
        ctx, if_match=value, drg_route_distribution_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_add_drg_route_distribution_statements(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.add_drg_route_distribution_statements(
        ctx, drg_route_distribution_id=value, statements=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_remove_drg_route_distribution_statements(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.remove_drg_route_distribution_statements(
        ctx, drg_route_distribution_id=value, statement_ids=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_drg_route_tables(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_drg_route_tables(
        ...
        sort_by=value,
        sort_order=value,
        import_drg_route_distribution_id=value,
        lifecycle_state=value,
    )
    assert ret
    assert ret["result"]
...
async def test_delete_drg_route_table(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_drg_route_table(
        ctx, if_match=value, drg_route_table_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_add_drg_route_rules(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.add_drg_route_rules(
        ctx, drg_route_table_id=value, opc_retry_token=value, route_rules=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_remove_drg_route_rules(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.remove_drg_route_rules(
        ctx, drg_route_table_id=value, route_rule_ids=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_remove_import_drg_route_distribution(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.remove_import_drg_route_distribution(
        ctx, drg_route_table_id=value, opc_request_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_update_drg_route_rules(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.update_drg_route_rules(
        ctx, drg_route_table_id=value, route_rules=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_drg_route_rules(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_drg_route_rules(
        ctx, drg_route_table_id=value, limit=value, page=value, route_type=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_drg(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.get_drg(ctx, drg_id=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_update_drg(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.update_drg(
        ...
        drg_id=value,
        if_match=value,
        default_drg_route_tables=value,
        defined_tags=value,
        display_name=value,
        freeform_tags=value,
    )
...
async def test_delete_drg(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_drg(
        ctx, drg_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_upgrade_drg(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.upgrade_drg(
        ctx, drg_id=value, opc_request_id=value, opc_retry_token=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_upgrade_status(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_upgrade_status(
        ctx, drg_id=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_fast_connect_provider_service_key(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_fast_connect_provider_service_key(
        ctx, provider_service_id=value, provider_service_key_name=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_fast_connect_provider_virtual_circuit_bandwidth_shapes(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_fast_connect_provider_virtual_circuit_bandwidth_shapes(
        ctx, limit=value, page=value, provider_service_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_internet_gateway(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.get_internet_gateway(ctx, ig_id=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_delete_internet_gateway(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_internet_gateway(
        ctx, ig_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_ip_sec_connections(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_ip_sec_connections(
        ctx, compartment_id=value, drg_id=value, cpe_id=value, limit=value, page=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_create_ip_sec_connection(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.create_ip_sec_connection(
        ...
        compartment_id=value,
        cpe_id=value,
        cpe_local_identifier=value,
        cpe_local_identifier_type=value,
        defined_tags=value,
        display_name=value,
        drg_id=value,
        freeform_tags=value,
...
async def test_get_ip_sec_connection(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.get_ip_sec_connection(ctx, ipsc_id=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_delete_ip_sec_connection(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_ip_sec_connection(
        ctx, ipsc_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_ipsec_cpe_device_config_content(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_ipsec_cpe_device_config_content(
        ctx, ipsc_id=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_ip_sec_connection_tunnels(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_ip_sec_connection_tunnels(
        ctx, ipsc_id=value, limit=value, page=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_ip_sec_connection_tunnel(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_ip_sec_connection_tunnel(
        ctx, ipsc_id=value, tunnel_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_update_ip_sec_connection_tunnel(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.update_ip_sec_connection_tunnel(
        ...
        if_match=value,
        opc_request_id=value,
        bgp_session_config=value,
        display_name=value,
        dpd_config=value,
        encryption_domain_config=value,
        nat_translation_enabled=value,
        oracle_initiation=value,
        phase_one_config=value,
        phase_two_config=value,
        routing=value,
    )
    assert ret
    assert ret["result"]
...
async def test_list_ip_sec_connection_tunnel_routes(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_ip_sec_connection_tunnel_routes(
        ctx, ipsc_id=value, tunnel_id=value, limit=value, page=value, advertiser=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_update_ip_sec_connection_tunnel_shared_secret(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.update_ip_sec_connection_tunnel_shared_secret(
        ctx, ipsc_id=value, tunnel_id=value, if_match=value, shared_secret=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_tunnel_cpe_device_config(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_tunnel_cpe_device_config(
        ctx, ipsc_id=value, tunnel_id=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_update_tunnel_cpe_device_config(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.update_tunnel_cpe_device_config(
        ...
        opc_retry_token=value,
        opc_request_id=value,
        tunnel_cpe_device_config=value,
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_ip_sec_connection_tunnel_security_associations(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_ip_sec_connection_tunnel_security_associations(
        ctx, ipsc_id=value, tunnel_id=value, limit=value, page=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_create_ipv6(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.create_ipv6(
        ...
        freeform_tags=value,
        ip_address=value,
        ipv6_subnet_cidr=value,
        is_internet_access_allowed=value,
        vnic_id=value,
    )
    assert ret
    assert ret["result"]
...
async def test_get_ipv6(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_ipv6(
        ctx, ipv6_id=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_ipv6(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_ipv6(
        ctx, ipv6_id=value, if_match=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_local_peering_gateways(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_local_peering_gateways(
        ctx, compartment_id=value, limit=value, page=value, vcn_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_local_peering_gateway(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_local_peering_gateway(
        ctx, local_peering_gateway_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_local_peering_gateway(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_local_peering_gateway(
        ctx, local_peering_gateway_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_connect_local_peering_gateways(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.connect_local_peering_gateways(
        ctx, local_peering_gateway_id=value, peer_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_nat_gateway(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.get_nat_gateway(ctx, nat_gateway_id=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_delete_nat_gateway(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_nat_gateway(
        ctx, if_match=value, nat_gateway_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_network_security_group(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_network_security_group(
        ctx, network_security_group_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_network_security_group(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_network_security_group(
        ctx, if_match=value, network_security_group_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_add_network_security_group_security_rules(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.add_network_security_group_security_rules(
        ctx, network_security_group_id=value, security_rules=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_remove_network_security_group_security_rules(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = (
        await hub.tool.oci.virtual_network.remove_network_security_group_security_rules(
            ctx, network_security_group_id=value, security_rule_ids=value
        )
    )
    assert ret
    assert ret["result"]
...
async def test_update_network_security_group_security_rules(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = (
        await hub.tool.oci.virtual_network.update_network_security_group_security_rules(
            ctx, network_security_group_id=value, security_rules=value
        )
    )
    assert ret
...
async def test_get_networking_topology(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_networking_topology(
        ...
        compartment_id=value,
        access_level=value,
        query_compartment_subtree=value,
        opc_request_id=value,
        if_none_match=value,
        cache_control=value,
    )
...
async def test_get_private_ip(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.get_private_ip(ctx, private_ip_id=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_delete_private_ip(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_private_ip(
        ctx, private_ip_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_public_ip_pool(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_public_ip_pool(
        ctx, opc_request_id=value, public_ip_pool_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_public_ip_pool(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_public_ip_pool(
        ctx, opc_request_id=value, public_ip_pool_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_public_ip(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.get_public_ip(ctx, public_ip_id=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_delete_public_ip(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_public_ip(
        ctx, public_ip_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_remote_peering_connections(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_remote_peering_connections(
        ctx, compartment_id=value, drg_id=value, limit=value, page=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_remote_peering_connection(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_remote_peering_connection(
        ctx, remote_peering_connection_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_remote_peering_connection(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_remote_peering_connection(
        ctx, if_match=value, remote_peering_connection_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_change_remote_peering_connection_compartment(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = (
        await hub.tool.oci.virtual_network.change_remote_peering_connection_compartment(
            ctx,
            remote_peering_connection_id=value,
            opc_request_id=value,
            opc_retry_token=value,
...
async def test_connect_remote_peering_connections(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.connect_remote_peering_connections(
        ctx, remote_peering_connection_id=value, peer_id=value, peer_region_name=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_route_table(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.get_route_table(ctx, rt_id=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_delete_route_table(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_route_table(
        ctx, rt_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_security_list(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_security_list(
        ctx, security_list_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_service_gateway(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_service_gateway(
        ctx, service_gateway_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_attach_service_id(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.attach_service_id(
        ctx, if_match=value, service_gateway_id=value, service_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_services(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.list_services(ctx, limit=value, page=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_get_service(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.get_service(ctx, service_id=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_create_subnet(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.create_subnet(
        ...
        prohibit_public_ip_on_vnic=value,
        route_table_id=value,
        security_list_ids=value,
        vcn_id=value,
    )
    assert ret
    assert ret["result"]
...
async def test_get_subnet(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.get_subnet(ctx, subnet_id=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_delete_subnet(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_subnet(
        ctx, subnet_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_create_vcn(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.create_vcn(
        ...
        freeform_tags=value,
        ipv6_cidr_block=value,
        ipv6_private_cidr_blocks=value,
        is_ipv6_enabled=value,
        is_oracle_gua_allocation_enabled=value,
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_vcn(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.get_vcn(ctx, vcn_id=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_delete_vcn(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_vcn(
        ctx, vcn_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_add_ipv6_vcn_cidr(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.add_ipv6_vcn_cidr(
        ...
        opc_retry_token=value,
        if_match=value,
        byoipv6_cidr_detail=value,
        ipv6_private_cidr_block=value,
        is_oracle_gua_allocation_enabled=value,
    )
    assert ret
    assert ret["result"]
...
async def test_modify_vcn_cidr(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.modify_vcn_cidr(
        ...
        opc_retry_token=value,
        if_match=value,
        new_cidr_block=value,
        original_cidr_block=value,
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_create_virtual_circuit(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.create_virtual_circuit(
        ctx,
        opc_retry_token=value,
        bandwidth_shape_name=value,
        bgp_admin_state=value,
        compartment_id=value,
        cross_connect_mappings=value,
        customer_bgp_asn=value,
        defined_tags=value,
        display_name=value,
        freeform_tags=value,
        gateway_id=value,
        ip_mtu=value,
        is_bfd_enabled=value,
        is_transport_mode=value,
        provider_name=value,
        provider_service_id=value,
        provider_service_key_name=value,
        provider_service_name=value,
        public_prefixes=value,
        region=value,
...
async def test_delete_virtual_circuit(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_virtual_circuit(
        ctx, virtual_circuit_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_bulk_add_virtual_circuit_public_prefixes(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.bulk_add_virtual_circuit_public_prefixes(
        ctx, virtual_circuit_id=value, public_prefixes=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_bulk_delete_virtual_circuit_public_prefixes(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = (
        await hub.tool.oci.virtual_network.bulk_delete_virtual_circuit_public_prefixes(
            ctx, virtual_circuit_id=value, public_prefixes=value
        )
    )
    assert ret
...
async def test_list_virtual_circuit_associated_tunnels(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_virtual_circuit_associated_tunnels(
        ctx, virtual_circuit_id=value, limit=value, page=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_cross_connect_mappings(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_cross_connect_mappings(
        ctx, opc_request_id=value, virtual_circuit_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_list_virtual_circuit_public_prefixes(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.list_virtual_circuit_public_prefixes(
        ctx, virtual_circuit_id=value, verification_state=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_vlan(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_vlan(
        ctx, vlan_id=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_vlan(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_vlan(
        ctx, vlan_id=value, if_match=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_vnic(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = await hub.tool.oci.virtual_network.get_vnic(ctx, vnic_id=value)
    assert ret
    assert ret["result"]
    assert ret["ret"]
    ret["ret"]
...
async def test_create_vtap(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.create_vtap(
        ...
        defined_tags=value,
        display_name=value,
        encapsulation_protocol=value,
        freeform_tags=value,
        is_vtap_enabled=value,
        max_packet_size=value,
        source_id=value,
        source_private_endpoint_ip=value,
        source_private_endpoint_subnet_id=value,
        source_type=value,
        target_id=value,
        target_ip=value,
        target_type=value,
        traffic_mode=value,
        vcn_id=value,
        vxlan_network_identifier=value,
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_vtap(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.get_vtap(
        ctx, vtap_id=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_vtap(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.virtual_network.delete_vtap(
        ctx, vtap_id=value, if_match=value, opc_request_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
