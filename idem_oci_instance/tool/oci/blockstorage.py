...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"availabilityDomain": availability_domain, "compartmentId": compartment_id, "limit": limit, "page": page, "displayName": display_name, "sortBy": sort_by, "sortOrder": sort_order, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "bootVolumeId": boot_volume_id, "limit": limit, "page": page, "displayName": display_name, "sourceBootVolumeBackupId": source_boot_volume_backup_id, "sortBy": sort_by, "sortOrder": sort_order, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'boot_volume_id': 'bootVolumeId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'kms_key_id': 'kmsKeyId', 'type': 'type'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'kms_key_id': 'kmsKeyId'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'destination_region': 'destinationRegion', 'display_name': 'displayName', 'kms_key_id': 'kmsKeyId'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"availabilityDomain": availability_domain, "compartmentId": compartment_id, "limit": limit, "page": page, "volumeGroupId": volume_group_id},
        data=payload,
        headers={},
    )
...
async def create_boot_volume(
    ...
    opc_retry_token: str = None,
    autotune_policies: List[make_dataclass(
        "autotune_policies",
        [
            ("autotune_type", str)
        ]
    ...
    boot_volume_replicas: List[make_dataclass(
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'autotune_policies': 'autotunePolicies', 'availability_domain': 'availabilityDomain', 'boot_volume_replicas': 'bootVolumeReplicas', 'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'is_auto_tune_enabled': 'isAutoTuneEnabled', 'kms_key_id': 'kmsKeyId', 'size_in_g_bs': 'sizeInGBs', 'source_details': 'sourceDetails', 'vpus_per_gb': 'vpusPerGB'}
...
async def get_boot_volume(
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/bootVolumes/{bootVolumeId}".format(
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'autotune_policies': 'autotunePolicies', 'boot_volume_replicas': 'bootVolumeReplicas', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'is_auto_tune_enabled': 'isAutoTuneEnabled', 'size_in_g_bs': 'sizeInGBs', 'vpus_per_gb': 'vpusPerGB'}
...
requests, the behaviour is just like `NUMERIC_SECONDS`.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'destination_region': 'destinationRegion', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'schedules': 'schedules'}
...
async def get_volume_backup_policy(
    hub,
    ctx,
    policy_id: str
) -> Dict[str, Any]:
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/volumeBackupPolicies/{policyId}".format(
            **{"policyId": policy_id}
        ),
        query_params={},
        data=payload,
...
requests, the behaviour is just like `NUMERIC_SECONDS`.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'destination_region': 'destinationRegion', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'schedules': 'schedules'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "volumeId": volume_id, "limit": limit, "page": page, "displayName": display_name, "sourceVolumeBackupId": source_volume_backup_id, "sortBy": sort_by, "sortOrder": sort_order, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'kms_key_id': 'kmsKeyId', 'type': 'type', 'volume_id': 'volumeId'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "volumeGroupId": volume_group_id, "limit": limit, "page": page, "displayName": display_name, "sortBy": sort_by, "sortOrder": sort_order},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'type': 'type', 'volume_group_id': 'volumeGroupId'}
...
async def create_volume_group(
    ...
    display_name: str = None,
    freeform_tags: Dict = None,
    volume_group_replicas: List[make_dataclass(
...
Avoid entering confidential information.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'availability_domain': 'availabilityDomain', 'backup_policy_id': 'backupPolicyId', 'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'source_details': 'sourceDetails', 'volume_group_replicas': 'volumeGroupReplicas'}
...
Avoid entering confidential information.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'volume_group_replicas': 'volumeGroupReplicas', 'volume_ids': 'volumeIds'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"availabilityDomain": availability_domain, "compartmentId": compartment_id, "limit": limit, "page": page, "displayName": display_name, "sortBy": sort_by, "sortOrder": sort_order, "volumeGroupId": volume_group_id, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
async def create_volume(
    ...
    availability_domain: str = None,
    backup_policy_id: str = None,
    block_volume_replicas: List[make_dataclass(
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'autotune_policies': 'autotunePolicies', 'availability_domain': 'availabilityDomain', 'backup_policy_id': 'backupPolicyId', 'block_volume_replicas': 'blockVolumeReplicas', 'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'is_auto_tune_enabled': 'isAutoTuneEnabled', 'kms_key_id': 'kmsKeyId', 'size_in_g_bs': 'sizeInGBs', 'size_in_m_bs': 'sizeInMBs', 'source_details': 'sourceDetails', 'volume_backup_id': 'volumeBackupId', 'vpus_per_gb': 'vpusPerGB'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'autotune_policies': 'autotunePolicies', 'block_volume_replicas': 'blockVolumeReplicas', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'is_auto_tune_enabled': 'isAutoTuneEnabled', 'size_in_g_bs': 'sizeInGBs', 'vpus_per_gb': 'vpusPerGB'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/volumes/{volumeId}/kmsKey".format(
            **{"volumeId": volume_id}
        ),
        query_params={},
        data=payload,
