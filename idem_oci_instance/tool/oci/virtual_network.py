...
async def list_allowed_peer_regions_for_remote_peering(
    hub,
    ctx
) -> Dict[str, Any]:
    r"""
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"limit": limit, "page": page, "displayName": display_name, "lifecycleState": lifecycle_state, "sortBy": sort_by, "sortOrder": sort_order, "compartmentId": compartment_id},
        data=payload,
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'cidr_block': 'cidrBlock', 'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'ipv6_cidr_block': 'ipv6CidrBlock'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/byoipRanges/{byoipRangeId}".format(
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "limit": limit, "page": page, "sortBy": sort_by, "sortOrder": sort_order, "displayName": display_name, "lifecycleState": lifecycle_state},
        data=payload,
        headers={"opc-request-id": opc_request_id},
    )
...
async def create_capture_filter(
    ...
    display_name: str = None,
    freeform_tags: Dict = None,
    vtap_capture_filter_rules: List[make_dataclass(
        "vtap_capture_filter_rules",
        [
            ("traffic_direction", str), 
            ("destination_cidr", str, field(default=None)), 
            ("icmp_options", make_dataclass(
            "icmp_options",
            [
                ("type", int), 
            ...
            ("tcp_options", make_dataclass(
            "tcp_options",
            [
                ("destination_port_range", make_dataclass(
                ...
                ("source_port_range", make_dataclass(
                "source_port_range",
                [
                    ("max", int), 
                    ("min", int)
...
a single port number, set both the min and max to the same value.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'filter_type': 'filterType', 'freeform_tags': 'freeformTags', 'vtap_capture_filter_rules': 'vtapCaptureFilterRules'}
...
a single port number, set both the min and max to the same value.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'vtap_capture_filter_rules': 'vtapCaptureFilterRules'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'cpe_device_shape_id': 'cpeDeviceShapeId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'ip_address': 'ipAddress', 'is_private': 'isPrivate'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'cpe_device_shape_id': 'cpeDeviceShapeId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="post",
        path="/cpes/{cpeId}/actions/changeCompartment".format(
            **{"cpeId": cpe_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/cpes/{cpeId}/cpeConfigContent".format(
            **{"cpeId": cpe_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "limit": limit, "page": page, "displayName": display_name, "sortBy": sort_by, "sortOrder": sort_order, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
NOTE: Only the latest secret version will be used.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'customer_reference_name': 'customerReferenceName', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'macsec_properties': 'macsecProperties'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'customer_reference_name': 'customerReferenceName', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'macsec_properties': 'macsecProperties'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "crossConnectGroupId": cross_connect_group_id, "limit": limit, "page": page, "displayName": display_name, "sortBy": sort_by, "sortOrder": sort_order, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'cross_connect_group_id': 'crossConnectGroupId', 'customer_reference_name': 'customerReferenceName', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'far_cross_connect_or_cross_connect_group_id': 'farCrossConnectOrCrossConnectGroupId', 'freeform_tags': 'freeformTags', 'location_name': 'locationName', 'macsec_properties': 'macsecProperties', 'near_cross_connect_or_cross_connect_group_id': 'nearCrossConnectOrCrossConnectGroupId', 'port_speed_shape_name': 'portSpeedShapeName'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'customer_reference_name': 'customerReferenceName', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'is_active': 'isActive', 'macsec_properties': 'macsecProperties'}
...
async def get_cross_connect_status(
    hub,
    ctx,
    cross_connect_id: str
) -> Dict[str, Any]:
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "vcnId": vcn_id, "limit": limit, "page": page, "displayName": display_name, "sortBy": sort_by, "sortOrder": sort_order, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'options': 'options', 'vcn_id': 'vcnId'}
...
`SearchDomain` (for [DhcpSearchDomainOption](#/en/iaas/latest/DhcpSearchDomainOption/)).
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'options': 'options'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="post",
        path="/dhcps/{dhcpId}/actions/changeCompartment".format(
            **{"dhcpId": dhcp_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "vcnId": vcn_id, "drgId": drg_id, "limit": limit, "page": page, "networkId": network_id, "attachmentType": attachment_type, "drgRouteTableId": drg_route_table_id, "displayName": display_name, "sortBy": sort_by, "sortOrder": sort_order, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'drg_id': 'drgId', 'drg_route_table_id': 'drgRouteTableId', 'freeform_tags': 'freeformTags', 'network_details': 'networkDetails', 'route_table_id': 'routeTableId', 'vcn_id': 'vcnId'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'drg_route_table_id': 'drgRouteTableId', 'export_drg_route_distribution_id': 'exportDrgRouteDistributionId', 'freeform_tags': 'freeformTags', 'network_details': 'networkDetails', 'route_table_id': 'routeTableId'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"drgId": drg_id, "limit": limit, "page": page, "displayName": display_name, "sortBy": sort_by, "sortOrder": sort_order, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'distribution_type': 'distributionType', 'drg_id': 'drgId', 'freeform_tags': 'freeformTags'}
...
async def add_drg_route_distribution_statements(
    ...
    ctx,
    drg_route_distribution_id: str,
    statements: List[make_dataclass(
        "statements",
        [
            ("action", str), 
            ("match_criteria", List[make_dataclass(
            "match_criteria",
            [
                ("match_type", str)
            ]
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"limit": limit, "page": page, "sortBy": sort_by, "sortOrder": sort_order},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"drgId": drg_id, "limit": limit, "page": page, "displayName": display_name, "sortBy": sort_by, "sortOrder": sort_order, "importDrgRouteDistributionId": import_drg_route_distribution_id, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'drg_id': 'drgId', 'freeform_tags': 'freeformTags', 'import_drg_route_distribution_id': 'importDrgRouteDistributionId', 'is_ecmp_enabled': 'isEcmpEnabled'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'import_drg_route_distribution_id': 'importDrgRouteDistributionId', 'is_ecmp_enabled': 'isEcmpEnabled'}
...
async def add_drg_route_rules(
    ...
    drg_route_table_id: str,
    opc_retry_token: str = None,
    route_rules: List[make_dataclass(
        "route_rules",
        [
            ("destination", str), 
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'default_drg_route_tables': 'defaultDrgRouteTables', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="post",
        path="/drgs/{drgId}/actions/getAllDrgAttachments".format(
            **{"drgId": drg_id}
        ),
        query_params={"limit": limit, "page": page, "attachmentType": attachment_type, "isCrossTenancy": is_cross_tenancy},
        data=payload,
        headers={"opc-request-id": opc_request_id},
    )
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="post",
        path="/drgs/{drgId}/actions/upgrade".format(
            **{"drgId": drg_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/drgs/{drgId}/actions/upgradeStatus".format(
            **{"drgId": drg_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/drgs/{drgId}/redundancyStatus".format(
            **{"drgId": drg_id}
        ),
        query_params={},
        data=payload,
...
.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        path="/fastConnectProviderServices/{providerServiceId}/providerServiceKeys/{providerServiceKeyName}".format(
            **{"providerServiceId": provider_service_id, "providerServiceKeyName": provider_service_key_name}
        ),
        query_params={},
        data=payload,
        headers={},
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'is_enabled': 'isEnabled', 'route_table_id': 'routeTableId', 'vcn_id': 'vcnId'}
...
async def get_internet_gateway(
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/internetGateways/{igId}".format(
            **{"igId": ig_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'is_enabled': 'isEnabled', 'route_table_id': 'routeTableId'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "drgId": drg_id, "cpeId": cpe_id, "limit": limit, "page": page},
        data=payload,
        headers={},
    )
...
async def create_ip_sec_connection(
    ...
    display_name: str = None,
    freeform_tags: Dict = None,
    tunnel_configuration: List[make_dataclass(
...
you like with [UpdateIPSecConnectionTunnelSharedSecret](#/en/iaas/latest/IPSecConnectionTunnelSharedSecret/UpdateIPSecConnectionTunnelSharedSecret).
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'cpe_id': 'cpeId', 'cpe_local_identifier': 'cpeLocalIdentifier', 'cpe_local_identifier_type': 'cpeLocalIdentifierType', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'drg_id': 'drgId', 'freeform_tags': 'freeformTags', 'static_routes': 'staticRoutes', 'tunnel_configuration': 'tunnelConfiguration'}
...
async def get_ip_sec_connection(
    hub,
    ctx,
    ipsc_id: str
) -> Dict[str, Any]:
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/ipsecConnections/{ipscId}".format(
            **{"ipscId": ipsc_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'cpe_local_identifier': 'cpeLocalIdentifier', 'cpe_local_identifier_type': 'cpeLocalIdentifierType', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'static_routes': 'staticRoutes'}
...
async def get_ip_sec_connection_device_config(
    hub,
    ctx,
    ipsc_id: str
) -> Dict[str, Any]:
    ...
    * [GetIPSecConnectionTunnelSharedSecret](#/en/iaas/latest/IPSecConnectionTunnelSharedSecret/GetIPSecConnectionTunnelSharedSecret)
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/ipsecConnections/{ipscId}/deviceConfig".format(
            **{"ipscId": ipsc_id}
        ),
        query_params={},
        data=payload,
...
async def get_ip_sec_connection_device_status(
    hub,
    ctx,
    ipsc_id: str
) -> Dict[str, Any]:
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/ipsecConnections/{ipscId}/deviceStatus".format(
            **{"ipscId": ipsc_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/ipsecConnections/{ipscId}/tunnels".format(
            **{"ipscId": ipsc_id}
        ),
        query_params={"limit": limit, "page": page},
        data=payload,
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'bgp_session_config': 'bgpSessionConfig', 'display_name': 'displayName', 'dpd_config': 'dpdConfig', 'encryption_domain_config': 'encryptionDomainConfig', 'nat_translation_enabled': 'natTranslationEnabled', 'oracle_initiation': 'oracleInitiation', 'phase_one_config': 'phaseOneConfig', 'phase_two_config': 'phaseTwoConfig', 'routing': 'routing'}
...
async def update_tunnel_cpe_device_config(
    ...
    opc_retry_token: str = None,
    opc_request_id: str = None,
    tunnel_cpe_device_config: List[make_dataclass(
...
[CpeDeviceConfigQuestion](#/en/iaas/latest/datatypes/CpeDeviceConfigQuestion).
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={},
        data=payload,
        headers={"if-match": if_match, "opc-retry-token": opc_retry_token, "opc-request-id": opc_request_id},
    )
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"limit": limit, "page": page, "ipAddress": ip_address, "subnetId": subnet_id, "vnicId": vnic_id},
        data=payload,
        headers={"opc-request-id": opc_request_id},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'ip_address': 'ipAddress', 'ipv6_subnet_cidr': 'ipv6SubnetCidr', 'is_internet_access_allowed': 'isInternetAccessAllowed', 'vnic_id': 'vnicId'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'is_internet_access_allowed': 'isInternetAccessAllowed', 'vnic_id': 'vnicId'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "limit": limit, "page": page, "vcnId": vcn_id},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'route_table_id': 'routeTableId', 'vcn_id': 'vcnId'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'route_table_id': 'routeTableId'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'block_traffic': 'blockTraffic', 'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'public_ip_id': 'publicIpId', 'route_table_id': 'routeTableId', 'vcn_id': 'vcnId'}
...
async def get_nat_gateway(
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/natGateways/{natGatewayId}".format(
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'block_traffic': 'blockTraffic', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'route_table_id': 'routeTableId'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "vlanId": vlan_id, "vcnId": vcn_id, "limit": limit, "page": page, "displayName": display_name, "sortBy": sort_by, "sortOrder": sort_order, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'vcn_id': 'vcnId'}
...
async def add_network_security_group_security_rules(
    ...
    ctx,
    network_security_group_id: str,
    security_rules: List[make_dataclass(
        "security_rules",
        [
            ("direction", str), 
            ("protocol", str), 
...
async def remove_network_security_group_security_rules(
    ...
    ctx,
    network_security_group_id: str,
    security_rule_ids: List[str] = None
) -> Dict[str, Any]:
    r"""
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"direction": direction, "limit": limit, "page": page, "sortBy": sort_by, "sortOrder": sort_order},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "accessLevel": access_level, "queryCompartmentSubtree": query_compartment_subtree},
        data=payload,
        headers={"opc-request-id": opc_request_id, "if-none-match": if_none_match, "cache-control": cache_control},
    )
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"limit": limit, "page": page, "ipAddress": ip_address, "subnetId": subnet_id, "vnicId": vnic_id, "vlanId": vlan_id},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'hostname_label': 'hostnameLabel', 'ip_address': 'ipAddress', 'vlan_id': 'vlanId', 'vnic_id': 'vnicId'}
...
async def get_private_ip(
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/privateIps/{privateIpId}".format(
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'hostname_label': 'hostnameLabel', 'vnic_id': 'vnicId'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"limit": limit, "page": page, "displayName": display_name, "byoipRangeId": byoip_range_id, "sortBy": sort_by, "sortOrder": sort_order, "compartmentId": compartment_id},
        data=payload,
        headers={"opc-request-id": opc_request_id},
    )
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"limit": limit, "page": page, "scope": scope, "availabilityDomain": availability_domain, "lifetime": lifetime, "compartmentId": compartment_id, "publicIpPoolId": public_ip_pool_id},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'lifetime': 'lifetime', 'private_ip_id': 'privateIpId', 'public_ip_pool_id': 'publicIpPoolId'}
...
async def get_public_ip_by_ip_address(
    hub,
    ctx,
    ip_address: str
) -> Dict[str, Any]:
...
async def get_public_ip(
    ...
    **Note:** If you're fetching a reserved public IP that is in the process of being
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/publicIps/{publicIpId}".format(
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'private_ip_id': 'privateIpId'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "drgId": drg_id, "limit": limit, "page": page},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'drg_id': 'drgId', 'freeform_tags': 'freeformTags'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "limit": limit, "page": page, "vcnId": vcn_id, "displayName": display_name, "sortBy": sort_by, "sortOrder": sort_order, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'route_rules': 'routeRules', 'vcn_id': 'vcnId'}
...
[Route Tables](/iaas/Content/Network/Tasks/managingroutetables.htm).
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'route_rules': 'routeRules'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="post",
        path="/routeTables/{rtId}/actions/changeCompartment".format(
            **{"rtId": rt_id}
        ),
        query_params={},
        data=payload,
...
async def create_security_list(
    ...
    ctx,
    compartment_id: str,
    egress_security_rules: List[make_dataclass(
    ...
    ingress_security_rules: List[make_dataclass(
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'egress_security_rules': 'egressSecurityRules', 'freeform_tags': 'freeformTags', 'ingress_security_rules': 'ingressSecurityRules', 'vcn_id': 'vcnId'}
...
a single port number, set both the min and max to the same value.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'egress_security_rules': 'egressSecurityRules', 'freeform_tags': 'freeformTags', 'ingress_security_rules': 'ingressSecurityRules'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "vcnId": vcn_id, "limit": limit, "page": page, "sortBy": sort_by, "sortOrder": sort_order, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'route_table_id': 'routeTableId', 'services': 'services', 'vcn_id': 'vcnId'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'block_traffic': 'blockTraffic', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'route_table_id': 'routeTableId', 'services': 'services'}
...
async def get_service(
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="get",
        path="/services/{serviceId}".format(
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "accessLevel": access_level, "queryCompartmentSubtree": query_compartment_subtree, "subnetId": subnet_id},
        data=payload,
        headers={"opc-request-id": opc_request_id, "if-none-match": if_none_match, "cache-control": cache_control},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'availability_domain': 'availabilityDomain', 'cidr_block': 'cidrBlock', 'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'dhcp_options_id': 'dhcpOptionsId', 'display_name': 'displayName', 'dns_label': 'dnsLabel', 'freeform_tags': 'freeformTags', 'ipv6_cidr_block': 'ipv6CidrBlock', 'ipv6_cidr_blocks': 'ipv6CidrBlocks', 'prohibit_public_ip_on_vnic': 'prohibitPublicIpOnVnic', 'route_table_id': 'routeTableId', 'security_list_ids': 'securityListIds', 'vcn_id': 'vcnId'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'dhcp_options_id': 'dhcpOptionsId', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'ipv6_cidr_block': 'ipv6CidrBlock', 'ipv6_cidr_blocks': 'ipv6CidrBlocks', 'route_table_id': 'routeTableId', 'security_list_ids': 'securityListIds'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={},
        data=payload,
        headers={"opc-retry-token": opc_retry_token, "if-match": if_match, "opc-request-id": opc_request_id},
    )
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "accessLevel": access_level, "queryCompartmentSubtree": query_compartment_subtree, "vcnId": vcn_id},
        data=payload,
        headers={"opc-request-id": opc_request_id, "if-none-match": if_none_match, "cache-control": cache_control},
    )
...
async def create_vcn(
    ...
    compartment_id: str,
    opc_retry_token: str = None,
    byoipv6_cidr_details: List[make_dataclass(
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'byoipv6_cidr_details': 'byoipv6CidrDetails', 'cidr_block': 'cidrBlock', 'cidr_blocks': 'cidrBlocks', 'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'dns_label': 'dnsLabel', 'freeform_tags': 'freeformTags', 'ipv6_cidr_block': 'ipv6CidrBlock', 'ipv6_private_cidr_blocks': 'ipv6PrivateCidrBlocks', 'is_ipv6_enabled': 'isIpv6Enabled', 'is_oracle_gua_allocation_enabled': 'isOracleGuaAllocationEnabled'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="post",
        path="/vcns/{vcnId}/actions/addCidr".format(
            **{"vcnId": vcn_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'byoipv6_cidr_detail': 'byoipv6CidrDetail', 'ipv6_private_cidr_block': 'ipv6PrivateCidrBlock', 'is_oracle_gua_allocation_enabled': 'isOracleGuaAllocationEnabled'}

    ret = await hub.tool.oci.session.request(
        ctx,
        method="post",
        path="/vcns/{vcnId}/actions/addIpv6Cidr".format(
            **{"vcnId": vcn_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="post",
        path="/vcns/{vcnId}/actions/changeCompartment".format(
            **{"vcnId": vcn_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'new_cidr_block': 'newCidrBlock', 'original_cidr_block': 'originalCidrBlock'}

    ret = await hub.tool.oci.session.request(
        ctx,
        method="post",
        path="/vcns/{vcnId}/actions/modifyCidr".format(
            **{"vcnId": vcn_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="post",
        path="/vcns/{vcnId}/actions/removeCidr".format(
            **{"vcnId": vcn_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="post",
        path="/vcns/{vcnId}/actions/removeIpv6Cidr".format(
            **{"vcnId": vcn_id}
        ),
        query_params={},
        data=payload,
...
async def create_virtual_circuit(
    ...
    cross_connect_mappings: List[make_dataclass(
    ...
    public_prefixes: List[make_dataclass(
        "public_prefixes",
        [
            ("cidr_block", str)
        ]
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'bandwidth_shape_name': 'bandwidthShapeName', 'bgp_admin_state': 'bgpAdminState', 'compartment_id': 'compartmentId', 'cross_connect_mappings': 'crossConnectMappings', 'customer_bgp_asn': 'customerBgpAsn', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'gateway_id': 'gatewayId', 'ip_mtu': 'ipMtu', 'is_bfd_enabled': 'isBfdEnabled', 'is_transport_mode': 'isTransportMode', 'provider_name': 'providerName', 'provider_service_id': 'providerServiceId', 'provider_service_key_name': 'providerServiceKeyName', 'provider_service_name': 'providerServiceName', 'public_prefixes': 'publicPrefixes', 'region': 'region', 'routing_policy': 'routingPolicy', 'type': 'type'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'bandwidth_shape_name': 'bandwidthShapeName', 'bgp_admin_state': 'bgpAdminState', 'cross_connect_mappings': 'crossConnectMappings', 'customer_bgp_asn': 'customerBgpAsn', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'gateway_id': 'gatewayId', 'ip_mtu': 'ipMtu', 'is_bfd_enabled': 'isBfdEnabled', 'is_transport_mode': 'isTransportMode', 'provider_service_key_name': 'providerServiceKeyName', 'provider_state': 'providerState', 'reference_comment': 'referenceComment', 'routing_policy': 'routingPolicy'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'availability_domain': 'availabilityDomain', 'cidr_block': 'cidrBlock', 'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'nsg_ids': 'nsgIds', 'route_table_id': 'routeTableId', 'vcn_id': 'vcnId', 'vlan_tag': 'vlanTag'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'nsg_ids': 'nsgIds', 'route_table_id': 'routeTableId'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="post",
        path="/vlans/{vlanId}/actions/changeCompartment".format(
            **{"vlanId": vlan_id}
        ),
        query_params={},
        data=payload,
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'hostname_label': 'hostnameLabel', 'nsg_ids': 'nsgIds', 'skip_source_dest_check': 'skipSourceDestCheck'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "vcnId": vcn_id, "source": source, "targetId": target_id, "targetIp": target_ip, "isVtapEnabled": is_vtap_enabled, "limit": limit, "page": page, "sortBy": sort_by, "sortOrder": sort_order, "displayName": display_name, "lifecycleState": lifecycle_state},
        data=payload,
        headers={"opc-request-id": opc_request_id},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'capture_filter_id': 'captureFilterId', 'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'encapsulation_protocol': 'encapsulationProtocol', 'freeform_tags': 'freeformTags', 'is_vtap_enabled': 'isVtapEnabled', 'max_packet_size': 'maxPacketSize', 'source_id': 'sourceId', 'source_private_endpoint_ip': 'sourcePrivateEndpointIp', 'source_private_endpoint_subnet_id': 'sourcePrivateEndpointSubnetId', 'source_type': 'sourceType', 'target_id': 'targetId', 'target_ip': 'targetIp', 'target_type': 'targetType', 'traffic_mode': 'trafficMode', 'vcn_id': 'vcnId', 'vxlan_network_identifier': 'vxlanNetworkIdentifier'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'capture_filter_id': 'captureFilterId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'encapsulation_protocol': 'encapsulationProtocol', 'freeform_tags': 'freeformTags', 'is_vtap_enabled': 'isVtapEnabled', 'max_packet_size': 'maxPacketSize', 'source_id': 'sourceId', 'source_private_endpoint_ip': 'sourcePrivateEndpointIp', 'source_private_endpoint_subnet_id': 'sourcePrivateEndpointSubnetId', 'source_type': 'sourceType', 'target_id': 'targetId', 'target_ip': 'targetIp', 'target_type': 'targetType', 'traffic_mode': 'trafficMode', 'vxlan_network_identifier': 'vxlanNetworkIdentifier'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ctx,
        method="post",
        path="/vtaps/{vtapId}/actions/changeCompartment".format(
            **{"vtapId": vtap_id}
        ),
        query_params={},
        data=payload,
