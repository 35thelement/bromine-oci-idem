...
async def list_(hub, ctx) -> Dict[str, Any]:
    ...
    list = await hub.tool.oci.session.request(
        ...
        path="/instances/",
        query_params={
            "compartmentId": "ocid1.compartment.oc1..aaaaaaaalqkhaj33ysfopolw5xuqbjwcvfengjflmpite5edzwym2awomoiq"
        },
        data={},
    ...
    for resource in list["ret"]:
        ...
        resource["resource_id"] = resource.get("id")
