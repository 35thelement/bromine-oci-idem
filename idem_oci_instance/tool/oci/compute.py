...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"availabilityDomain": availability_domain, "capacityReservationId": capacity_reservation_id, "computeClusterId": compute_cluster_id, "compartmentId": compartment_id, "displayName": display_name, "limit": limit, "page": page, "sortBy": sort_by, "sortOrder": sort_order, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
async def launch_instance(
    ...
    agent_config: make_dataclass(
        ...
        [
            ...
            ("plugins_config", List[make_dataclass(
            "plugins_config",
            [
                ("desired_state", str), 
                ("name", str)
    ...
    preemptible_instance_config: make_dataclass(
        ...
        [
            ("preemption_action", make_dataclass(
            "preemption_action",
            [
                ("type", str)
            ]
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'agent_config': 'agentConfig', 'availability_config': 'availabilityConfig', 'availability_domain': 'availabilityDomain', 'capacity_reservation_id': 'capacityReservationId', 'compartment_id': 'compartmentId', 'compute_cluster_id': 'computeClusterId', 'create_vnic_details': 'createVnicDetails', 'dedicated_vm_host_id': 'dedicatedVmHostId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'extended_metadata': 'extendedMetadata', 'fault_domain': 'faultDomain', 'freeform_tags': 'freeformTags', 'hostname_label': 'hostnameLabel', 'image_id': 'imageId', 'instance_options': 'instanceOptions', 'ipxe_script': 'ipxeScript', 'is_pv_encryption_in_transit_enabled': 'isPvEncryptionInTransitEnabled', 'launch_mode': 'launchMode', 'launch_options': 'launchOptions', 'metadata': 'metadata', 'platform_config': 'platformConfig', 'preemptible_instance_config': 'preemptibleInstanceConfig', 'shape': 'shape', 'shape_config': 'shapeConfig', 'source_details': 'sourceDetails', 'subnet_id': 'subnetId'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'agent_config': 'agentConfig', 'availability_config': 'availabilityConfig', 'capacity_reservation_id': 'capacityReservationId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'extended_metadata': 'extendedMetadata', 'fault_domain': 'faultDomain', 'freeform_tags': 'freeformTags', 'instance_options': 'instanceOptions', 'launch_options': 'launchOptions', 'metadata': 'metadata', 'shape': 'shape', 'shape_config': 'shapeConfig', 'time_maintenance_reboot_due': 'timeMaintenanceRebootDue', 'update_operation_constraint': 'updateOperationConstraint'}
