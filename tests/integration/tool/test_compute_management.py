...
async def test_create_cluster_network(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.compute_management.create_cluster_network(
        ...
        display_name=value,
        freeform_tags=value,
        instance_pools=value,
        placement_configuration=value,
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_terminate_cluster_network(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.compute_management.terminate_cluster_network(
        ctx, cluster_network_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_instance_configuration(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.compute_management.get_instance_configuration(
        ctx, instance_configuration_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_delete_instance_configuration(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.compute_management.delete_instance_configuration(
        ctx, instance_configuration_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_change_instance_configuration_compartment(hub, ctx):
    ...
    **Test function**
    ...
    # TODO: replace call param values as necessary
    ret = (
        await hub.tool.oci.compute_management.change_instance_configuration_compartment(
            ctx,
            instance_configuration_id=value,
            if_match=value,
            opc_request_id=value,
...
async def test_launch_instance_configuration(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.compute_management.launch_instance_configuration(
        ctx, instance_configuration_id=value, opc_retry_token=value, instance_type=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_create_instance_pool(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.compute_management.create_instance_pool(
        ...
        freeform_tags=value,
        instance_configuration_id=value,
        instance_display_name_formatter=value,
        instance_hostname_formatter=value,
        load_balancers=value,
        placement_configurations=value,
        size=value,
    )
    assert ret
    assert ret["result"]
...
async def test_terminate_instance_pool(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.compute_management.terminate_instance_pool(
        ctx, instance_pool_id=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_attach_load_balancer(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.compute_management.attach_load_balancer(
        ...
        opc_retry_token=value,
        if_match=value,
        backend_set_name=value,
        load_balancer_id=value,
        port=value,
        vnic_selection=value,
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_detach_instance_pool_instance(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.compute_management.detach_instance_pool_instance(
        ...
        opc_retry_token=value,
        instance_id=value,
        is_auto_terminate=value,
        is_decrement_size=value,
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_reset_instance_pool(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.compute_management.reset_instance_pool(
        ctx, instance_pool_id=value, opc_retry_token=value, if_match=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_attach_instance_pool_instance(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.compute_management.attach_instance_pool_instance(
        ctx, instance_pool_id=value, opc_retry_token=value, instance_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_instance_pool_instance(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.compute_management.get_instance_pool_instance(
        ctx, instance_pool_id=value, instance_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
...
async def test_get_instance_pool_load_balancer_attachment(hub, ctx):
    ...
    **Test function**
    ...
    ret = await hub.tool.oci.compute_management.get_instance_pool_load_balancer_attachment(
        ctx, instance_pool_id=value, instance_pool_load_balancer_attachment_id=value
    )
    assert ret
    assert ret["result"]
    assert ret["ret"]
