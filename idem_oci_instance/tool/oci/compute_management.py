...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "displayName": display_name, "limit": limit, "page": page, "sortBy": sort_by, "sortOrder": sort_order, "lifecycleState": lifecycle_state},
        data=payload,
        headers={},
    )
...
async def create_cluster_network(
    ...
    ctx,
    compartment_id: str,
    instance_pools: List[make_dataclass(
        "instance_pools",
        [
    ...
    placement_configuration: make_dataclass(
        ...
        [
            ...
            ("primary_vnic_subnets", make_dataclass(
            ...
            ("secondary_vnic_subnets", List[make_dataclass(
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'instance_pools': 'instancePools', 'placement_configuration': 'placementConfiguration'}
...
operation.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'instance_pools': 'instancePools'}
...
. Defaults to None.
    ...
    ret = await hub.tool.oci.session.request(
        ...
        query_params={"compartmentId": compartment_id, "limit": limit, "page": page, "sortBy": sort_by, "sortOrder": sort_order},
        data=payload,
        headers={},
    )
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'source': 'source'}
...
async def create_instance_pool(
    ...
    compartment_id: str,
    instance_configuration_id: str,
    placement_configurations: List[make_dataclass(
    ...
    load_balancers: List[make_dataclass(
        "load_balancers",
        [
...
that is associated with the instance pool.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'compartment_id': 'compartmentId', 'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'instance_configuration_id': 'instanceConfigurationId', 'instance_display_name_formatter': 'instanceDisplayNameFormatter', 'instance_hostname_formatter': 'instanceHostnameFormatter', 'load_balancers': 'loadBalancers', 'placement_configurations': 'placementConfigurations', 'size': 'size'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'defined_tags': 'definedTags', 'display_name': 'displayName', 'freeform_tags': 'freeformTags', 'instance_configuration_id': 'instanceConfigurationId', 'instance_display_name_formatter': 'instanceDisplayNameFormatter', 'instance_hostname_formatter': 'instanceHostnameFormatter', 'placement_configurations': 'placementConfigurations', 'size': 'size'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'backend_set_name': 'backendSetName', 'load_balancer_id': 'loadBalancerId', 'port': 'port', 'vnic_selection': 'vnicSelection'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'instance_id': 'instanceId', 'is_auto_terminate': 'isAutoTerminate', 'is_decrement_size': 'isDecrementSize'}
...
. Defaults to None.
    ...
    # TODO: Change request param mapping as necessary
    payload = {'backend_set_name': 'backendSetName', 'load_balancer_id': 'loadBalancerId'}
...
async def get_instance_pool_load_balancer_attachment(
    ...
    ret = await hub.tool.oci.session.request(
        ...
        path="/instancePools/{instancePoolId}/loadBalancerAttachments/{instancePoolLoadBalancerAttachmentId}".format(
            **{"instancePoolId": instance_pool_id, "instancePoolLoadBalancerAttachmentId": instance_pool_load_balancer_attachment_id}
        ),
        query_params={},
        data=payload,
        headers={},
